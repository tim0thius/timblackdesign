	...
	class Zozo_Breadcrumbs {
		...
		public function __construct() {
			...
			$defaults = array(
				 ...
				 'show_terms'  				=> 1,
				 'home_label'      			=> __( 'Home', 'zozothemes' ),
				 'tag_archive_prefix'   	=> __( 'Tag:', 'zozothemes' ),
				 'search_prefix'        	=> __( 'Search:', 'zozothemes' ),
				 'error_prefix' 			=> __( '404 - Page not Found', 'zozothemes' ),
			);
